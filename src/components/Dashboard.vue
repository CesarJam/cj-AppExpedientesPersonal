...
<template>
    <div class="p-6 max-w-7xl mx-auto transition-colors duration-300 space-y-8">
      ...
      <div class="flex items-center gap-3">
        ...
        <button @click="$emit('cerrar')" class="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg font-medium transition shadow-sm border border-gray-200 dark:border-gray-600">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
